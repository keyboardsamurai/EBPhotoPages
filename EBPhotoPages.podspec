...
The library was designed using a state pattern to control the behavior of the gallery, so that other developers can easily modify or add new states without having to understand too much of the original code."
  s.homepage     = "https://github.com/keyboardsamurai/EBPhotoPages"
  s.screenshots  = "https://github.com/keyboardsamurai/EBPhotoPages/blob/master/1.png?raw=true", "https://github.com/keyboardsamurai/EBPhotoPages/blob/master/EBPhotoPages@1x.png?raw=true"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author             = "Eddy Borja"
  s.social_media_url   = "http://twitter.com/eddyborja_"
  s.platform     = :ios, '7.0'
  s.source       = { :git => "https://github.com/keyboardsamurai/EBPhotoPages.git", :tag => "0.9.1" }
